...
Далее в README находится подробное описание архитектуры, инструкций по настройке устройств Hikvision, формата config.yaml, тестирования и рекомендаций по развертыванию. При необходимости могу добавить или подправить эти разделы.
